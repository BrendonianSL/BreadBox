...
export default function ArticleListItem({ id, article }) {
    return (
        <Link style={{ color: 'white' }} to={`${article.article_slug}`}>
            <div className={styles['listItem']}>
                <div className={styles['listItem-image_container']}>
                    <img className={styles['listItemThumbnail']} src={article.article_image} alt={`Article Thumbnail For ${article.title}`} />
                </div>
